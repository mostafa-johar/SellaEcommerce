...
<template>
  <header>
        ...
        <section class="flex gap-2 py-2 items-center justify-center">
          ...
          <div class="flex-1 lg:flex justify-end hidden">
            <ul class="flex gap-4 items-center">
              ...
              >
                <img
                  src="@/assets/imgs/KSA.png"
                  alt="KSA"
                  class="object-contain ml-1"
                  v-if="link.name == 'العربية'"
                />
                <img
                  src="@/assets/imgs/Line-2.png"
                  alt="line"
                  class="object-contain ml-1"
                  v-if="link.name !== 'العربية'"
                />
    ...
    <section class="bottom-header">
      ...
      <div class="container mx-auto px-3">
        <div
          class="flex md:gap-12 gap-8 items-center justify-between md:py-8 pt-4"
        >
          <section class="flex gap-2">
            <!-- menu-->
            <button class="lg:hidden" v-on:click="toggleBTN = !toggleBTN">
              <img
            ...
            <router-link to="/" class="flex gap-2 items-center">
              ...
              />
              <h3
                class="md:w-[55px] w-[40px] md:text-[22px] text-gray-600 font-bold"
              >
                متجر سلة
              </h3>
            </router-link>
          ...
          <section class="relative lg:block hidden">
            <input
              type="text"
          ...
          <section class="flex md:gap-8 gap-2">
            <div class="flex gap-2 items-center">
              <div
                class="w-10 h-10 rounded-full bg-gray-50 flex justify-center items-center p-2"
              >
                <img
            ...
            <router-link to="/cart">
              <div class="flex gap-2 items-center">
                ...
                <p class="flex-1">
                  <span class="text-sm text-gray-400 hover:text-teal-400"
                    >سلة المشتريات</span
                  >
        ...
        <section class="relative lg:hidden my-4">
          <input
            type="text"
            placeholder="ابحث عما تريد"
            class="w-full lg:w-[600px] h-[48px] outline-none border-[1px] border-gray-300 rounded-md p-4"
      ...
      <!-- nav -->
      <nav
        class="lg:bg-black bg-white z-10 border-gray-50 border-b-[1px] py-2 lg:block absolute top-0 transition-all h-full lg:relative"
        :class="
          toggleBTN
            ? 'w-[250px] right-0'
            : 'right-[-250px] lg:right-0 lg:w-auto'
        "
      >
        <div class="container mx-auto px-3">
          <span
            class="absolute top-20 -left-[30px] w-[30px] h-[30px] rounded-ee-md rounded-se-md bg-teal-400 hover:bg-teal-600 text-white flex justify-center items-center select-none cursor-pointer lg:hidden"
            v-on:click="toggleBTN = !toggleBTN"
            >x</span
          >
          <ul
            class="flex flex-col lg:flex-row gap-6 justify-center lg:items-center flex-wrap"
          >
            <li class="lg:hidden block">
              <p class="text-gray-600 font-semibold text-sm py-4 border-b-2">
                جميع الاقسام
              </p>
            </li>
            <li
              ...
              :key="index"
            >
              <router-link to="/AllProducts" class="lg:text-white text-base">{{
                navlink.name
              }}</router-link>
              <img
                src="@/assets/imgs/arrowDown.png"
                alt="arrowDown"
