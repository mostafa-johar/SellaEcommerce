...
export const useStore = defineStore('products', () => {
  ...
  const minus = (index) => (cartBox.value[index].quantity !== 0) ? cartBox.value[index].quantity-- : (cartBox.value[index].quantity = 0)
  ...
  return {getImg, products, totalPrice, addCountCart, cartBox, deleteProduct, add, minus, totalCount }
